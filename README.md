...
- Fomos buscar melhorias, apenas uma análise do plano preliminar. Por exemplo, a especificação contém "épicos", são "gigantes", precisamos dividi-los em histórias menores, com entregáveis claros, mas não queria alterar os requisitos iniciais. Então o plano foi revisado. O plano revisado é apresentado [aqui](./docs/plano-revisitado.md). Até aqui tudo humano, mas dá para perceber que é preciso organizar ainda melhor.
- Usei o ChatGPT com um prompt visando ajudar a dividir as histórias e organizá-las em sprints sem divergir muito do que está no plano revisitado. Ela gerou rapidamente o [Plano Revisitado #2](./docs/plano-revisitado-v2.md), eu teria levado muito, muito mais tempo para fazer o mesmo, mas também não faria igual, mas serve como "pronto" para o planejamento da primeira iteração (sprint), identificando as tarefas, de uma forma bem mais organizada. 
- Em essência, o [plano revisitado](./docs/plano-revisitado.md) refinou os requisitos (épicos) em itens menores com entregáveis claros, e o [Plano Revisitado #2](./docs/plano-revisitado-v2.md) formalizou esses itens como histórias de usuário organizadas em sprints orientadas a valor. 
